...
import { StyleSheet, Text, View, Button, TextInput, KeyboardAvoidingView ,ScrollView, FlatList, Image, Icon } from 'react-native';
...
export default class ChatWith extends Component {
    ...
    renderItem = ({ item }) => {
        ...
        if (item.sender === '1') {
            return <Reply message={item.msg} />
        }
        else {
            return <Recieve message={item.msg} />
        }
    }
            ...
            <View style={{ flex: 1,justifyContent:'space-between' }} >
             ...
             <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding"  >
                ...
                />
                    ...
                    <Input containerStyle={{width:'80%'}} placeholder='Type Message' />
                        <ElementButton title='SEND' buttonStyle={{backgroundColor: '#4267b2'}} />
                    </View>
